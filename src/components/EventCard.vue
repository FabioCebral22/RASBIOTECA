<template>
    <div class="event-card">
        <div class="event-image">
            <img :src='"http://raul-argemi-7e6.alwaysdata.net" + event.event_image' :alt="event.event_name">
        </div>
    ...
    methods: {
        async loadTickets() {
            try {
                ...
                const response = await fetch(`http://raul-argemi-7e6.alwaysdata.net/api/tickets`, {
                    method: 'POST',
                    headers: {
